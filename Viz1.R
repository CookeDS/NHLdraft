setwd("C:/Users/keega/OneDrive/Desktop/Project/NHLDraft/Draft")

df1 = read.csv("nhldraft.csv")
...
# Remove point shares 
df1 <- df1 %>%
  mutate(point_shares = NULL, 
         id = NULL, 
         to_year = NULL)
 
#-----------------------------------------------------------------------

# Question: (Top 100 picks) Which position has the highest % of players that play 200+ games between year 1995-2015? (5 - year intervals)
